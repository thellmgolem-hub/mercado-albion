...
SUPPLEMENT = {
    ...
    "Quiver": "Aljava",
    # buffs / passivas de item / skills das classes novas (PT oficial do dump)
    "Heroic Charge": "Carga Heroica",
    "Displacement Immunity": "Imunidade ao deslocamento",
    "Force Shield": "Escudo de Força",
    "Air Compressor": "Compressor de Ar",
    "Sacred Ground": "Solo Sagrado",
    "Snare Charge": "Investida Ardilosa",
    "Life Leech": "Parasita de Vida",
    "Increased Defense": "Defesa Aumentada",
    "Enfeeble Aura": "Aura Debilitante",
    "Block": "Bloqueio",
    "Gigantify": "de Crescimento",
    # skills de item-set citadas na prosa (PT oficial do dump)
    "Rooting Smash": "Golpe Enraizante",
    "Sacred Pulse": "Pulsação Sagrada",
    "Defenseless Rush": "Ímpeto Indefensável",
    "Life Steal Aura": "Aura Sugadora de Vida",
    "Raging Blink": "Lampejo Feroz",
    "Meditation": "Meditação",
    "Force Pulse": "Pulso de Força",
    "Shield Charge": "Investida com Escudo",
    "Energy Shield": "Escudo de Energia",
    # armas citadas por nome curto na prosa
    "Great Holy Staff": "Cajado Sagrado Elevado",
    "Great Holy": "Cajado Sagrado Elevado",
    "Fallen Staff": "Cajado Corrompido",
    "Redemption Staff": "Cajado da Redenção",
    "Lifecurse Staff": "Cajado Execrado",
    "Damnation Staff": "Cajado da Danação",
    "Hellion Jacket": "Casaco Inferial",
    "Hellion Hood": "Capuz Inferial",
    "Hellion": "Casaco Inferial",
    "Fallen": "Cajado Corrompido",
    "Redemption": "Redenção",
    "Lifecurse": "Cajado Execrado",
    "Damnation": "Danação",
    "Guardian": "Guardião",
    "Rush": "Arremetida",
}
