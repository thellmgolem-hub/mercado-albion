...
# O 10 no início da escala 24h deixa o sweep da NUVEM guardar só 10 dias:
...
# Medição fina pós-TRUNCATE: 30d ~= 378 MB de history => 14d ~= 343 (ENCOSTA
# no soft de 340 e oscila). Com 10 dias: history ~126 MB, total ~293 — folga real.
# Pedidos de 90/180/365 seguem servidos p/ o app local (SQLite).
HISTORY_FETCH_WINDOWS = {24: [10, 30, 90, 180, 365], 6: [30, 90], 1: [7, 30]}
...
# nuvem; a poda (HISTORY_RETENTION_DAYS) mantém a tabela nesse tamanho.
